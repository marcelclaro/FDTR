...
class Domain:
	...
	def add_substrate(self, material):
		if( not self.substrate_defined):
			...
			self.heat_path.append(Layer(50e-4,self.temperature,material(self.temperature)))
	...
	def set_layer_param(self, index, **parameter):
		...
		if 'thickness' in parameter: self.heat_path[index*2].thickness = parameter['thickness']
